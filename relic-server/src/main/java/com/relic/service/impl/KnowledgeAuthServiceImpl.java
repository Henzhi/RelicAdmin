...
public class KnowledgeAuthServiceImpl implements KnowledgeAuthService {
    ...
    public UserVO login(LoginDTO dto) {
        ...
        if (!"knowledge".equals(user.getUserType())) {
            throw new AccountNotFoundException("非知识服务用户");
        }
    ...
    public String generateToken(Integer userId, String username) {
        ...
        return JwtUtil.createJWT(jwtProperties.getKnowledgeSecretKey(), jwtProperties.getKnowledgeTtl(), claims);
    }
